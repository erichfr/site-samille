...
<head>
    <meta charset="utf-8">
    <title>Samille Reis - Quadros</title>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar text-white-50 row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div class="col-lg-6 px-5 text-end">
                ...
                <a class="text-white-50 ms-3" href="https://www.instagram.com/millescapes/" target="_blank"><i class="fab fa-instagram"></i></a>
                <a class="text-white-50 ms-3" href="tel:552199657434"><i class="fab fa fa-phone" target="_blank"></i></a>
                <a class="text-white-50 ms-3" href="mailto:reissamille@gmail.com"><i class="fa fa-envelope" target="_blank"></i></a>
            </div>
        </div>

        <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="fw-bold text-danger m-0">Samille<span class="text-white">Reis</span></h1>
            </a>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="donate.html" class="dropdown-item">Sudeste Brasileiro</a>
                            <a href="service.html" class="dropdown-item">Nordeste Brasileiro</a>
                            <a href="team.html" class="dropdown-item">Norte Brasileiro</a>
                            <a href="team.html" class="dropdown-item">Sul Brasileiro</a>
                            <a href="testimonial.html" class="dropdown-item">Internacionais</a>
                            <a href="404.html" class="dropdown-item">Mais Obras</a>
                        </div>
                    </div>
                    <a href="causes.html" class="nav-item nav-link">Depoimentos</a>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/lençóis-156.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <!-- <div class="col-lg-7 pt-5">
                                    <h1 class="display-4 text-white mb-3 animated slideInDown">Todos os seres humanos nascem livres e iguais em dignidade e</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/ilha grande-59.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <!-- <div class="col-lg-7 pt-5">
                ...
                <!-- <div class="carousel-item">
                    <img class="w-100" src="img/ilha grande-84.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <!-- <div class="col-lg-7 pt-5">
